...
* [User Experience (UX)](#user-experience-uxu)
...
### Site Goals
The goal of the Bike Shed Conwy is to inform users of its bicycle repair and maintenence services. The site should be easy to navigate an  provide clear and consise information on the services it offers.
...
![Font Awesome](https://fontawesome.com/) icons were used throughoutt heh site, such as on the 'reasons' area and the social media icons in the footer.
...
### Content
* The content on the services page was loosley based on list of services on [WECycle](https://www.wecycle.co.uk/pages/workshop/) 
...
* I would like to thank:
  * My Code Institute Mentor and Cohort Supervisor, [Elaine Broche](https://github.com/elainebroche-dev) and [Iris Smok](https://www.linkedin.com/in/irissmok/) repectively who have provided great advice and feedback on how to plan and execute this project.
