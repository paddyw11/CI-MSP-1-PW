...
| --- | --- | --- |
| Chrome | ![screenshot](documentation/browser-testing/chrome-home.webp) | Works as expected |
| Firefox | ![screenshot](documentation/browser-testing/firefox-home.webp) | Works as expected |
| Edge | ![screenshot](documentation/browser-testing/edge-home.webp) | Works as expected |
| Opera | ![screenshot](documentation/browser-testing/opera-home.webp) | Works as expected |
| Internet Explorer | ![screenshot](documentation/browser-testing/internet-explorer-home.webp) | Does not work as expected as IE does not support webp image format or Bootstrap |
...
| --- | --- | --- | --- | --- | --- |
| Medium Mobile (DevTools) | ![screenshot](documentation/responsiveness-testing/mobile-home.png) | ![screenshot](documentation/responsiveness-testing/mobile-services.png) | ![screenshot](documentation/responsiveness-testing/mobile-book-now.png) | ![screenshot](documentation/responsiveness-testing/mobile-contact.png) | Works as expected |
| Tablet (DevTools) | ![screenshot](documentation/responsiveness-testing/tablet-home.png) | ![screenshot](documentation/responsiveness-testing/tablet-services.png) | ![screenshot](documentation/responsiveness-testing/tablet-book-now.png) | ![screenshot](documentation/responsiveness-testing/tablet-contact.png) | Works as expected |
| Laptop (DevTools) | ![screenshot](documentation/responsiveness-testing/laptop-home.png) | ![screenshot](documentation/responsiveness-testing/laptop-services.png) | ![screenshot](documentation/responsiveness-testing/laptop-book-now.png) | ![screenshot](documentation/responsiveness-testing/laptop-contact.png) | Works as expected |
| Desktop | ![screenshot](documentation/responsiveness-testing/desktop-home.png) | ![screenshot](documentation/responsiveness-testing/desktop-services.png) | ![screenshot](documentation/responsiveness-testing/desktop-book-now.png) | ![screenshot](documentation/responsiveness-testing/desktop-contact.png) | Works as expected |
